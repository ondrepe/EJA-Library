...
@NamedQueries({
    ...
    @NamedQuery(name = "Authorization.findByLogin", query = "SELECT a FROM Authorization a WHERE a.login = :login"),
    @NamedQuery(name = "Authorization.findByPassword", query = "SELECT a FROM Authorization a WHERE a.password = :password")})
public class AuthorizationPO implements Serializable {
    ...
    public String toString() {
        return "cz.cvut.fel.x33eja.libejb.po.Authorization[login=" + login + "]";
    }
