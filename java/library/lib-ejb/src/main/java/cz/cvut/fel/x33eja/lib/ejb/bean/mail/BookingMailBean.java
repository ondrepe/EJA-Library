...
public class BookingMailBean implements MessageListener {
  ...
  private String createMessageText(MailObject notification) {
    ...
    builder.append("<table><tr><td>").append("Reader: ").append("</td><td>").append(notification.getName()).append(" ").append(notification.getSurname()).append("</td><td>").append(notification.getReaderEmail()).append("</td></tr></table>").append(LineSeparator.Web);
    builder.append("<br />").append(LineSeparator.Web);
    builder.append("<p>Blocked books: </p>").append(LineSeparator.Web);
    builder.append("<table>");
    builder.append("<thead><tr>").append("<th>Id</th>").append("<th>Book</th>").append("<th>From date</th>").append("<th>To date</th>").append("</tr></thead>").append(LineSeparator.Web);
