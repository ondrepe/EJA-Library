 ...
 * @author ondrepe
 */
@MessageDriven(mappedName = "jms/lib/notificationQueue", activationConfig = {
  @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
  @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue")
})
public class NotificationMailBean implements MessageListener {
  ...
  private String createMessageText(MailObject notification) {
    ...
    builder.append("<title>Notification</title><s/head><body>").append(LineSeparator.Web);
    ...
    builder.append("<p>Unreturned books: </p>").append(LineSeparator.Web);
